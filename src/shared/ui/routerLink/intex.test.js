...
describe('Test RouterLink component', () => {
    test('renders link with correct text and navigates to the expected route', async () => {
        ...
        (0, react_1.render)(react_2.default.createElement(react_router_dom_1.MemoryRouter, { initialEntries: ['/'] },
            ...
            react_2.default.createElement(react_router_dom_1.Routes, null,
                react_2.default.createElement(react_router_dom_1.Route, { index: true, element: react_2.default.createElement(react_2.default.Fragment, null) }),
                react_2.default.createElement(react_router_dom_1.Route, { path: testRoutePath, element: react_2.default.createElement("div", null, "Test Route Content") }))));
